...
Config.Locations = {
    ['Innocence'] = {
        settings = {
            label = 'Bennys Motorworks',
            welcomeLabel = "BEM VINDO A LOS SANTOS CUSTOMS!",
            enabled = true,
        },
        blip = {
            label = 'Bennys Motorworks',
            coords = vector3(-365.44, -85.11, 39.02),
            sprite = 72,
            scale = 0.65,
            color = 0,
            display = 4,
        ...
        zones = {
            { coords = vector3(-366.14, -85.35, 38.18), length = 6.0, width = 4.0, heading = 250.0, minZ = 38.0, maxZ = 42.0 },
        }
    },
