...
vehicleWheelOptions = {
    {category = "Pneu Custom", id = -1, wheelID = 23},
...
vehicleCustomisation = {
    ...
    {category = "Bumper Frontal", id = 1},
    {category = "Bumper Traseiro", id = 2},
    {category = "Skirt Lateral", id = 3},
    {category = "Exaustor", id = 4},
    {category = "Roll Cage", id = 5},
    {category = "Grille", id = 6},
    {category = "Capo", id = 7},
    {category = "Fendas Esquerda", id = 8},
    {category = "Fendas Direita", id = 9},
    {category = "Teto", id = 10},
    {category = "Upgrade Motor", id = 11},
    {category = "Upgrade Freio", id = 12},
    {category = "Upgrade Transmissao", id = 13},
    {category = "Upgrade Suspensao", id = 15},
    {category = "Upgrade Blindagem", id = 16},
    {category = "Upgrade Turbo", id = 18},
    {category = "Vanity Placas", id = 25},
