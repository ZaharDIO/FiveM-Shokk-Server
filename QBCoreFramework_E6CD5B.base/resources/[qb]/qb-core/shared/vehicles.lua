...
local Vehicles = {
    ...
    --- MOTOS
    { model = 'hayabusa',        name = 'Hayabusa',                      brand = 'Suzuki',          price = 400000,  category = 'motorcycles',    type = 'bike',            shop = 'luxury' },
    { model = 'haya24nbrt',      name = 'Hayabusa 24',                   brand = 'Suzuki',          price = 400000,  category = 'motorcycles',    type = 'bike',            shop = 'luxury' },
    { model = 'tf_bike',         name = 'Hayabusa Drag',                 brand = 'Suzuki',          price = 400000,  category = 'motorcycles',    type = 'bike',            shop = 'luxury' },
    { model = 'offlrds1000',     name = 'Ninja',                         brand = 'Kawasaki',        price = 400000,  category = 'motorcycles',    type = 'bike',            shop = 'luxury' },
    { model = 'gs310',           name = 'G310',                          brand = 'BMW',             price = 400000,  category = 'motorcycles',    type = 'bike',            shop = 'luxury' },
    --- COMPACTOS
    { model = 'aventador',       name = 'Aventador',                     brand = 'Lamborghini',     price = 400000,  category = 'compacts',       type = 'automobile',      shop = 'luxury' },
    { model = 'ferio',           name = 'Civic 97',                      brand = 'Honda',           price = 400000,  category = 'compacts',       type = 'automobile',      shop = 'luxury' },
    { model = 'c97hatch',        name = 'Civic 97 Hatch',                brand = 'Honda',           price = 400000,  category = 'compacts',       type = 'automobile',      shop = 'luxury' },
    { model = 'rrhot',           name = 'Ratrod 1936',                   brand = 'Ford',            price = 400000,  category = 'compacts',       type = 'automobile',      shop = 'luxury' },
    { model = 'rrvic',           name = 'Ford Monster ',                 brand = 'Ford',            price = 400000,  category = 'compacts',       type = 'automobile',      shop = 'luxury' },
    { model = 'copen',           name = 'Copen Coupe 2019',              brand = 'Daihatsu',        price = 400000,  category = 'compacts',       type = 'automobile',      shop = 'luxury' },
    { model = 'turtle',          name = 'Copen Coupe Conversivel',       brand = 'Daihatsu',        price = 400000,  category = 'compacts',       type = 'automobile',      shop = 'luxury' },
    --- SEDANS
    { model = 'nisa31',          name = 'Cefiro A31',                    brand = 'Nissan',          price = 400000,  category = 'sedans',         type = 'automobile',      shop = 'luxury' },
    { model = 'm3g80',           name = 'M3G80',                         brand = 'BMW',             price = 400000,  category = 'sedans',         type = 'automobile',      shop = 'luxury' },
    { model = 'mk2100',          name = 'Chaser MKII',                   brand = 'Toyota',          price = 400000,  category = 'sedans',         type = 'automobile',      shop = 'luxury' },
    { model = 'civic93',         name = 'Civic 93',                      brand = 'Honda',           price = 400000,  category = 'sedans',         type = 'automobile',      shop = 'luxury' },
    { model = 'c63w205',         name = 'AMG C63',                       brand = 'Mercedes',        price = 400000,  category = 'sedans',         type = 'automobile',      shop = 'luxury' },
    --- CAMINHONETES
    { model = 'rrcherokeel',     name = 'Cherokee 98',                   brand = 'Jeep',            price = 400000,  category = 'caminhonetes',   type = 'automobile',      shop = 'luxury' },
    { model = 'davidburb',       name = 'Suburban',                      brand = 'Chevrolet',       price = 400000,  category = 'caminhonetes',   type = 'automobile',      shop = 'luxury' },
    { model = 'rrdemondurango',  name = 'Durango',                       brand = 'Dodge',           price = 400000,  category = 'caminhonetes',   type = 'automobile',      shop = 'luxury' },
    
    --- COUPES
    { model = 'cyrus',           name = 'DBS',                           brand = 'Aston Martin',    price = 400000,  category = 'coupes',         type = 'automobile',      shop = 'luxury' },
    { model = 'rs6+',            name = 'RS6+',                          brand = 'Audi',            price = 400000,  category = 'coupes',         type = 'automobile',      shop = 'luxury' },
    { model = 'esnevox',         name = 'Lancer Evolution X',            brand = 'Mitsubishi',      price = 400000,  category = 'coupes',         type = 'automobile',      shop = 'luxury' },
    { model = 'palameila',       name = 'Panamera 4S',                   brand = 'Porsche',         price = 400000,  category = 'coupes',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrdemonmagnum',   name = 'Magnum',                        brand = 'Dodge',           price = 400000,  category = 'coupes',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrmaybach',       name = 'Emperor',                       brand = 'Scaldarsi',       price = 400000,  category = 'coupes',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrs15sh',         name = 'S15 JP',                        brand = 'Nissan',          price = 400000,  category = 'coupes',         type = 'automobile',      shop = 'luxury' },
    --- POTENTES
    { model = '69charger',       name = '69 Charger',                    brand = 'Dodge',           price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'redeye',          name = 'SRT Charger',                   brand = 'Dodge',           price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'boss302',         name = '69 Mustang',                    brand = 'Ford',            price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr21shelbystreet',name = 'Shelby 2021',                   brand = 'Ford',            price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr68demoncharger',name = 'Charger 68 Demon',              brand = 'Dodge',           price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr69fastback',    name = 'Mustang Boss 302',              brand = 'Ford',            price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr69gto',         name = 'GTO 69',                        brand = 'Pontiac',         price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr70bosswide',    name = 'Mustang Boss GTR',              brand = 'Ford',            price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr70split',       name = 'Camaro SS Super',               brand = 'Chevrolet',       price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrf100d',         name = 'F-100',                         brand = 'Ford',            price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrgnx',           name = 'GNX',                           brand = 'Buick',           price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrhelldart',      name = 'Hell Dart 1967',                brand = 'Dodge',           price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrws6',           name = 'TransAm',                       brand = 'Pontiac',         price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    { model = 'forgt50020',      name = 'Mustang Shelby GT500',          brand = 'Ford',            price = 400000,  category = 'muscle',         type = 'automobile',      shop = 'luxury' },
    --- ESPORTIVOS CLASSICOS
    { model = '84rx7k',          name = 'RX7 84',                        brand = 'Mazda',           price = 400000,  category = 'sportsclassics', type = 'automobile',      shop = 'luxury' },
    { model = 'rrgt500e',        name = 'Mustang Shelby GT500-69',       brand = 'Ford',            price = 400000,  category = 'sportsclassics', type = 'automobile',      shop = 'luxury' },
    --- ESPORTIVOS
    { model = '911turbos',       name = '911 T',                         brand = 'Porsche',         price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'grandgt20',       name = 'Grand GT',                      brand = 'Porsche',         price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'lp560',           name = 'Gallardo C',                    brand = 'Lamborghini',     price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'oycgt3rs',        name = 'GT3',                           brand = 'Porsche',         price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'pcs20',           name = 'Carrera S',                     brand = 'Porsche',         price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'pgt322',          name = 'GT3 22',                        brand = 'Porsche',         price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = '350z',            name = 'Nismo 350z',                    brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = '370z',            name = 'Nismo 370z',                    brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'gtrr32',          name = 'GTR R32',                       brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'dc2',             name = 'Integra',                       brand = 'Honda',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'supra2',          name = 'Supra 99',                      brand = 'Toyota',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'corvette',        name = 'C7',                            brand = 'Corvette',        price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'stagea',          name = 'Stagea',                        brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'z15drift',        name = 'Silvia S15 DFT',                brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'z15dragon',       name = 'Silvia S15 D',                  brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'z15tribal',       name = 'Silvia S15 T',                  brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'typex96',         name = 'Type X 96',                     brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'gxr35',           name = 'GTR 35 Nismo',                  brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'mxrb',            name = 'MX5 T',                         brand = 'Mazda',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'eclipse',         name = 'Eclipse 98',                    brand = 'Mitsubishi',      price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'silvias13',       name = 'Silvia S13',                    brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'z15clean',        name = 'Silvia S15 C',                  brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'gtrpit',          name = 'GTR 35 LB',                     brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'mads14',          name = 'Silvia S14',                    brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'is300',           name = 'IS300',                         brand = 'Lexus',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rx7tunable',      name = 'RX7 97 T',                      brand = 'Mazda',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'topfoil',         name = 'Lancer Evolution 7',            brand = 'Mitsubishi',      price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'e63sf',           name = 'AMG E63',                       brand = 'Mercedes',        price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'mazrx7fb',        name = 'RX7 89',                        brand = 'Mazda',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'fd3s',            name = 'RX7 97 N',                      brand = 'Mazda',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'wrx19',           name = 'WRX 19',                        brand = 'Subaru',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'variszupra',      name = 'Supra A80',                     brand = 'Toyota',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'ss16',            name = 'Camaro SS16',                   brand = 'Chevrolet',       price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'nissanr33tbk',    name = 'Skyline GTR33',                 brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'm3gtr',           name = 'M3 GTR',                        brand = 'BMW',             price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'huayrar',         name = 'Huayra R',                      brand = 'Pagani',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'skyline',         name = 'Skyline GTR34',                 brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'f488pista',       name = '488',                           brand = 'Ferrari',         price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'casup',           name = 'Supra Drift',                   brand = 'Toyota',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = '12charger',       name = 'Super Charger',                 brand = 'Dodge',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'r34speedhunter',  name = 'Skyline R-34 SH',               brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr04sti',         name = 'WRX STI',                       brand = 'Subaru',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr20amggt',       name = 'AMG GT-20',                     brand = 'Mercedes',        price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr20supra',       name = 'Supre 2024',                    brand = 'Toyota',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr21shelbyf150',  name = 'Shelby F-150',                  brand = 'Ford',            price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rr458lw',         name = 'F458 Spider LW',                brand = 'Ferrari',         price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrf8wide',        name = 'F8 Spider',                     brand = 'Ferrari',         price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrr32',           name = 'Skyline R2 JP',                 brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrr34w',          name = 'Skyline R34 Tunning',           brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'rrrx7wide',       name = 'RX-7 Super',                    brand = 'Mazda',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'nznismo24',       name = '370z 2024 Nismo',               brand = 'Nissan',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'a80',             name = 'Supre MK4',                     brand = 'Toyota',          price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'na6',             name = 'MX-5 Conversivel',              brand = 'Mazda',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    { model = 'fd',              name = 'RX-7 Hentai',                   brand = 'Mazda',           price = 400000,  category = 'sports',         type = 'automobile',      shop = 'luxury' },
    --- SUPER
    { model = 'cargt',           name = 'Carrera GT',                    brand = 'Porsche',         price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'p911r',           name = '911 R',                         brand = 'Porsche',         price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'porgt34',         name = 'GT 34',                        brand = 'Porsche',         price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'gt17',            name = 'GT 17',                         brand = 'Ford',            price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'fmgt',            name = 'Mustang GT',                    brand = 'Ford',            price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'c7',              name = 'C7 C',                          brand = 'Corvette',        price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'bmwm8',           name = 'M8',                            brand = 'BMW',             price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'F40LBWK',         name = 'F40 LBWK',                      brand = 'Ferrari',         price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'rx7v',            name = 'RX7 97',                        brand = 'Mazda',           price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'mclaren765',      name = '765LT',                         brand = 'McLaren',         price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'ocnlamtmc',       name = 'Terzo Millenio',                brand = 'Lamborghini',     price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'TecnidaTDB',      name = 'Huracan',                       brand = 'Lamborghini',     price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'lamrevuelto',     name = 'Revuelto',                      brand = 'Lamborghini',     price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'Revuelto',        name = 'Revuelto S',                    brand = 'Lamborghini',     price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'gtr',             name = 'Skyline GTR35',                 brand = 'Nissan',          price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'bmgolfr',         name = 'Golf 2025',                     brand = 'Volkswagen',      price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'fsf90xx',         name = 'SF90XX',                        brand = 'Ferrari',         price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'essenzascv12',    name = 'Centenario',                    brand = 'Lamborghini',     price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'chiron',          name = 'Chiron',                        brand = 'Bugatti',         price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'bolide',          name = 'Bolide',                        brand = 'Bugatti',         price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'aimgainnsx',      name = 'NSX',                           brand = 'Acura',           price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'r8v10abt',        name = 'R8',                            brand = 'Audi',            price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'r820',            name = 'R820',                          brand = 'Audi',            price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'rrmerci',         name = 'Murcielago LW',                 brand = 'Lamborghini',     price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'rrsaleens7',      name = 'S7 2007',                       brand = 'Saleen',          price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'rrtermivert',     name = 'SVT Cobra',                     brand = 'Ford',            price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'rrveneno',        name = 'Veneno',                        brand = 'Lamborghini',     price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'rrvulcan',        name = 'Martin Vulcan',                 brand = 'Aston',           price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    { model = 'rrwchiron',       name = 'Chiron',                        brand = 'Bugatti',         price = 400000,  category = 'super',          type = 'automobile',      shop = 'luxury' },
    --- OFF-ROAD
    { model = 'f15078',          name = 'F150 78',                       brand = 'Ford',            price = 400000,  category = 'offroad',        type = 'automobile',      shop = 'luxury' },
    { model = 'DragNova',        name = 'SS',                            brand = 'Chevy',           price = 400000,  category = 'offroad',        type = 'automobile',      shop = 'luxury' },
    { model = 'iak_wheelchair',  name = 'Xavier',                        brand = 'AACD',            price = 400000,  category = 'offroad',        type = 'automobile',      shop = 'luxury' },
    { model = 'rr20d',           name = 'Silverado 3500 HC',             brand = 'Chevrolet',       price = 400000,  category = 'offroad',        type = 'automobile',      shop = 'luxury' },
    { model = 'rrk30',           name = 'F250 1978',                     brand = 'Chevrolet',       price = 400000,  category = 'offroad',        type = 'automobile',      shop = 'luxury' },
    { model = 'rrobs',           name = 'F-250 1978',                    brand = 'ford',            price = 400000,  category = 'offroad',        type = 'automobile',      shop = 'luxury' },
    --- INDUSTRIAL
    { model = 'cargo815',        name = 'CARGO 815e',                    brand = 'Ford',            price = 400000,  category = 'industrial',     type = 'automobile',      shop = 'truck' },
    { model = 'caminoT3',        name = 'T3',                            brand = 'Camino',          price = 400000,  category = 'industrial',     type = 'automobile',      shop = 'truck' },
    --- ESPECIALIZADO
    { model = 'rrratrigt',       name = 'Truck Tunning',                 brand = 'Ford',            price = 400000,  category = 'industrial',     type = 'automobile',      shop = 'truck' },
    { model = 'rrsemihauler',    name = 'Trailer Tunnig',                brand = 'Ford',            price = 400000,  category = 'industrial',     type = 'automobile',      shop = 'truck' },
    { model = 'rrtrailer',       name = 'Mini Tunning',                  brand = 'Ford',            price = 400000,  category = 'industrial',     type = 'automobile',      shop = 'truck' },
    --- VANS
    { model = 'por20',           name = 'TTS',                           brand = 'Porsche',         price = 400000,  category = 'vans',           type = 'automobile',      shop = 'luxury' },
    { model = 'rrhellram',       name = 'RAM SRT',                       brand = 'Dodge',           price = 400000,  category = 'vans',           type = 'automobile',      shop = 'luxury' },
    --- EMERGÊNCIA
    { model = 'ABSHEL',          name = 'Mustang VTR',                   brand = 'Ford',            price = 400000,  category = 'emergency',      type = 'automobile',      shop = 'luxury' },
    { model = 'SHEL',            name = 'Mustang VTR 2',                 brand = 'Ford',            price = 400000,  category = 'emergency',      type = 'automobile',      shop = 'luxury' },
    { model = 'rr70bosswidepd',  name = 'Mustang BOSS DP',               brand = 'Ford',            price = 400000,  category = 'emergency',      type = 'automobile',      shop = 'luxury' },
    --- COMERCIAL
    { model = 'vnl780',          name = 'L780',                          brand = 'Volvo',           price = 400000,   category = 'commercial',    type = 'automobile',      shop = 'truck' },
    { model = 'actros',          name = 'Actros 63',                     brand = 'Mercedes',        price = 400000,   category = 'commercial',    type = 'automobile',      shop = 'truck' },
    { model = 'scaniar730',      name = 'R730',                          brand = 'SCANIA',          price = 400000,   category = 'commercial',    type = 'automobile',      shop = 'truck' },
    
    -- Delet
    { model = 'elegy2',           name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'rr68cont',         name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'xboxcumstang',    name = 'Mus', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'rrhellcat300n',    name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'rr21bronco',       name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'rrf450g',          name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'vofh21',          name = 'FH21',                          brand = 'Volvo',           price = 400000,   category = 'commercial',    type = 'automobile',      shop = 'truck' },
    
    
    
    --CATEGORIAS DE VEICULOS QUE NÃO TEM LUGAR
    { model = 'z15bad',           name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'z15power',         name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'g86',              name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'cheve70',          name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'rr69chargerpd',    name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'rrcanamx3',        name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'Irrgt500off',      name = '', brand = '', price = '', category = '', type = '', shop = '' },
    { model = 'Irrlavoiture',     name = '', brand = '', price = '', category = '', type = '', shop = '' },
    
    
    
    --- Compactos (0) Não mexer ANIMAL 
