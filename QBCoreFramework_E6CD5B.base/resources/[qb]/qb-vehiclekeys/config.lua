...
Config.DelayBetweenCarjackings = 1 -- Time before you can carjack again
...
Config.TimeBetweenHotwires = 1 -- Time in ms between hotwire attempts
Config.minHotwireTime = 200 -- Minimum hotwire time in ms
Config.maxHotwireTime = 400 --  Maximum hotwire time in ms
