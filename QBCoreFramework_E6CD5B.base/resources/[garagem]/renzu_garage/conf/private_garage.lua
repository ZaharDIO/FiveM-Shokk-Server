...
private_garage = {
    ...
    ['modern'] = { -- garage id
        ...
        cost = 100000, -- cost for purchase
        max = 38, -- max vehicles available for this garage
        buycoords = vector4(-144.07, -576.22, 32.42, 339.36),
        ...
        park = {
            ...
            --1A
            {coord = vector4(-67.37, -831.09, 221.66, 71.24) ,  taken = false},
            {coord = vector4(-67.35, -827.27, 221.66, 104.41),  taken = false},
            {coord = vector4(-68.9,  -823.73, 221.66, 116.31),  taken = false},
            {coord = vector4(-71.41, -820.8,  221.66, 145.04),  taken = false},
            {coord = vector4(-74.34, -819.39, 221.66, 164.87),  taken = false},
            {coord = vector4(-77.19, -819.0,  221.66, 174.39),  taken = false},
            {coord = vector4(-83.36, -816.65, 221.66, 200.81),  taken = false},
            {coord = vector4(-86.09, -818.07, 221.66, 211.27),  taken = false},
            {coord = vector4(-88.57, -819.78, 221.66, 214.79),  taken = false},
            {coord = vector4(-84.13, -831.6,  221.66, 38.13) ,  taken = false},
            --2B
            {coord = vector4(-67.64, -831.32, 226.86, 69.94) ,  taken = false},
            {coord = vector4(-67.09, -828.11, 226.86, 94.49) ,  taken = false},
            {coord = vector4(-67.75, -825.14, 226.86, 116.59),  taken = false},
            {coord = vector4(-69.41, -822.62, 226.85, 128.8) ,  taken = false},
            {coord = vector4(-72.17, -820.6, 226.86, 152.19) ,  taken = false},
            {coord = vector4(-74.96, -819.26, 226.86, 159.87),  taken = false},
            {coord = vector4(-78.97, -818.74, 226.86, 187.43),  taken = false},
            {coord = vector4(-83.61, -817.11, 226.86, 203.4) ,  taken = false},
            {coord = vector4(-87.06, -819.07, 226.86, 226.71),  taken = false},
            {coord = vector4(-83.2, -825.57, 226.86, 337.17) ,  taken = false},
            --3C
            {coord = vector4(-66.78, -832.11, 232.35, 64.19),  taken = false},
            {coord = vector4(-65.8, -827.54, 232.35, 114.48),  taken = false},
            {coord = vector4(-67.36, -824.43, 232.35, 122.71),  taken = false},
            {coord = vector4(-69.72, -821.8, 232.35, 136.12),  taken = false},
            {coord = vector4(-72.69, -819.62, 232.35, 145.78),  taken = false},
            {coord = vector4(-75.58, -818.14, 232.35, 155.74),  taken = false},
            {coord = vector4(-82.7, -816.38, 232.35, 212.19),  taken = false},
            {coord = vector4(-85.6, -818.32, 232.35, 211.64),  taken = false},
            {coord = vector4(-88.43, -820.28, 232.35, 217.0),  taken = false},
            {coord = vector4(-82.52, -825.9, 232.35, 328.64),  taken = false},
        },
    ...
    ['large3'] = { -- garage id
        ...
        cost = 10000, -- cost for purchase
        max  = 15, -- max vehicles available for this garage
        buycoords = vector4(-270.9, 279.46, 90.18, 179.82),
        coords = vector4(-270.76, 282.49, 90.36, 0.46),
        park = {
            {coord = vector4(233.80194091797,-1002.8353271484,-99.562438964844,98.076362609863), taken = false},
            {coord = vector4(233.70393371582,-999.49444580078,-99.562438964844,98.78751373291), taken = false},
            {coord = vector4(233.89929199219,-996.08715820312,-99.562713623047,102.9313659668), taken = false},
