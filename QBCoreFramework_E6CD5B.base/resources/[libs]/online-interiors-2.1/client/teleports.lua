local teleports = {
	...
	[188] = {text = "Casino Lobby", dest = {189,190}, x = 1085.29, y = 214.32, z = -49.20, h = 311.35},
	...
	[195] = {text = "Exit Casino", dest = {196}, x = 935.94, y = 46.80, z = 81.10, h = 152.99},
	...
	[199] = {text = "First Floor", dest = {197,198,200}, x = 332.15, y = -595.67, z = 43.28, h = 69.33},
	[200] = {text = "Helipad", dest = {197,198,199}, x = 338.99, y = -583.95, z = 74.16, h = 259.56},

	-- Bahama Mamas
	[201] = {text = "Bar Front", dest = {202}, x = -1385.29, y = -606.63, z = 30.32, h = 123.47},
	[202] = {text = "Bar Back", dest = {201}, x = -1371.55, y = -626.02, z = 30.82, h = 120.81},

	-- Triads
	[203] = {text = "Basement", dest = {204,205}, x = -817.86, y = -709.56, z = 23.78, h = 89.68}, 
	[204] = {text = "First Floor", dest = {203,205}, x = -817.57, y = -709.57, z = 28.06, h = 97.80},
	[205] = {text = "Second Floor", dest = {203,204}, x = -817.80, y = -709.64, z = 32.34, h = 87.69},
	[206] = {text = "Basement", dest = {207,208}, x = -817.63, y = -705.42, z = 23.78, h = 89.86},
	[207] = {text = "First Floor", dest = {206,208}, x = -817.72, y = -705.40, z = 28.06, h = 87.50},
	[208] = {text = "Second Floor", dest = {206,207}, x = -817.59, y = -705.43, z = 32.34, h = 91.40},
